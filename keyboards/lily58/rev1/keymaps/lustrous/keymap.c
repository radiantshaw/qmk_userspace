 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_ESC,   HRM_G_A,  HRM_A_S,  HRM_C_D,  HRM_S_F,  KC_G,                      KC_H,   HRM_S_J,  HRM_C_K,  HRM_A_L,  HRM_G_SCLN,  KC_QUOT,
  KC_TAB,   KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,  KC_LBRC,  KC_RBRC,  KC_N,   KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,     KC_BSLS,
